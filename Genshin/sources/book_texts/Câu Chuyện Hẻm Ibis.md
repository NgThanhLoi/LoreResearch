...
Moments later, a single arrow flew across the moon and tore apart the night sky.<ref group="Note">Reference to the feat of {{w|Nasu no Yoichi}} at {{w|Battle of Yashima}}.</ref>
...
People says she flew over eight ships in a row,<ref group="Note">Reference to the feat of {{w|Minamoto no Yoshitsune}} at {{w|Battle of Dan-no-Ura}}.</ref> then disappeared into the night. The feline youkai's laughter could be heard for more than three days after the battle has finished.
