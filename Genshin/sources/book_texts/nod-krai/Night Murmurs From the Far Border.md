...
title           = Night Murmurs From the Far Border
|image           = Book Night Murmurs From the Far Border.png
|quality         = 3
|volumes         = 1
|publisher       = 
|author          =Viliana 
...
'''''Night Murmurs From the Far Border''''' is a Book Collection.
...
==Trivia==
* The main character of this book, Czcibor, shares a name with a present-day NPC. Interestingly, the modern Czcibor once inexplicably disappeared while with friends in Barrowmoss Barrens, only to return "many days" later with no memory of his past or identity.<ref>Czcibor</ref>
* In Slavic mythology, a ''Werewolf in Slavic mythology|varcolac'' is a human-wolf shapeshifter, also known as a "werewolf." 
** An alternate spelling of the term, ''volkodlak'', also appears in the ''A Brief History of the Pale Starborn'', another in-game book collection.

==Other Languages==
default_hidden=1
|en       = Night Murmurs From the Far Border: Varcolac
|zhs      = 边乡夜语・鬣兽
|zhs_rm   = Biānxiāng Yèyǔ - Lièshòu
|zht      = 邊鄉夜語・鬣獸
|zht_rm   = Biānxiāng Yèyǔ - Lièshòu
|zh_tl    = 
|ja       = 辺境夜話・ヴァルコラク
|ja_rm    = Henkyou Yawa - Varukoraku
|ja_tl    = Night Chat at the Far Border - Varcolac
|ko       = 변방의 야화・갈기 야수
|ko_tl    = 
|es       = Relatos nocturnos de la frontera: Vârcolac
|es_tl    = 
|fr       = Murmures nocturnes de la frontière lointaine : Varcolac
|fr_tl    = Night Murmurs From the Far Border: Varcolac
|ru       = Ночной шёпот издалека: Варколак
|ru_tl    = Night Whisper from Afar: Varcolac
|th       = เรื่องเล่ายามราตรีจากชายแดน: วาร์โคลัก
|th_rm    = 
|th_tl    = 
|vi       = Chuyện Đêm Vùng Biên - Varcolac
|vi_tl    = 
|de       = Nachtgeflüster von der fernen Grenze &ndash; Varcolac
|de_tl    = 
|id       = Desiran Malam dari Perbatasan Jauh: Varcolac
|id_tl    = 
|pt       = Sussurros Noturnos da Fronteira Distante: Maneodon
|pt_tl    = 
|tr       = Uzak Sınırdan Gece Fısıltıları: Varcolac
|tr_tl    = 
|it       = Mormorii notturni dal confine lontano: Varcolac
|it_tl    = 
...
fr:Murmures nocturnes de la frontière lointaine