...
for d, fname, id_, type_, name, region in profiles:
    dir_path = f"d:/LoreResseach/Genshin/entities/{d}"
    os.makedirs(dir_path, exist_ok=True)
    file_path = f"{dir_path}/{fname}.md"
...
"""
        ...
        print(f"Created profile: {file_path}")
    else:
        print(f"Profile already exists: {file_path}")

print("Done generating manual profiles.")
