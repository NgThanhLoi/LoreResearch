...
* **Nếu viết Post-canon / Current Patch:** Phải khai báo rõ ràng **Patch Lock** (ví dụ: "Dựa trên nội dung cốt truyện tính đến Patch 6.0"). Mọi chi tiết cốt truyện ra mắt sau patch này của game sẽ được coi là thế giới song song nếu mâu thuẫn với truyện.
