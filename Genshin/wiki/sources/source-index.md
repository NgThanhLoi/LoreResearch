...
| **BK-0005** | `sources/book_texts/nod-krai/A Brief History of the Pale Starborn.md` | Book | High | Snezhnaya pre-history, Fae vs Volkodlak wars, Glupov founding | file-level | (research report only) | Nguồn sơ cấp lịch sử Snezhnaya / Nod-Krai. |
| **BK-0006** | `sources/book_texts/nod-krai/Conch Echoes.md` | Book | High | Giao ước ngầm của nhóm trẻ lưu đày | file-level | (research report only) | Nguồn sơ cấp dạng điển tích / ẩn dụ. |
| **BK-0007** | `sources/book_texts/nod-krai/Night Murmurs From the Far Border.md` | Book | High | Cơ chế sinh học và ma thuật Varcolac (werewolf) | file-level | (research report only) | Nguồn sơ cấp về Varcolac. |
| **BK-0008** | `sources/book_texts/nod-krai/Tales Carried by the Northwind.md` | Book | High | Thơ ca của người sáng lập Lightkeepers | file-level | (research report only) | Nguồn sơ cấp thơ ca Lightkeepers. |
| **BK-0009** | `sources/book_texts/nod-krai/The Legends of Reed Miller, Thief Extraordinaire.md` | Book | High | Truyền thuyết đạo tặc, Sampo Mill, Alia & Brahe | file-level | (research report only) | Nguồn sơ cấp văn học dân gian. |
| **AQ-NK-0001** | `sources/book_texts/nod-krai/A Dance of Snowy Tides and Hoarfrost Groves.md` | Quest Summary | Medium | Tóm tắt Archon Quest Chương V Act I, Kuuvahki, Columbina, Sandrone | file-level | (research report only) | Bản tóm tắt quest và dữ liệu chứng tích địa phương (không phải thoại thô). |
| **WQ-NK-0001** | `sources/book_texts/nod-krai/Beyond Silver and Fine Gold.md` | Quest Summary | Medium | World Quest chuỗi phòng Witch's Lodge, Nicole | file-level | (research report only) | Bản tóm tắt quest và hội thoại của Nicole (không phải thoại thô). |
...
## 2c. Pass 8 Character Story Source Candidates

| Source ID | Path | Source type | Reliability | Main topics | Indexed level | Used by pages | Notes |
| --------- | ---- | ----------- | ----------- | ----------- | ------------- | ------------- | ----- |
| **CS-KAEYA-001** | `sources/character_stories/Kaeya.md` | API Provenance Record | Medium | Kaeya profile, character story, Vision story | extraction index candidate | N/A | Ingested from Fandom MediaWiki API in Pass 8 and hardened in Pass 8.1; exact text not stored locally; source_status `extraction_index_candidate`; claim mapping must re-open revision `2108515`. |

## 2d. Pass NK-06 Snezhnaya / Nod-Krai Archon Quest Provenance Candidates

| Source ID | Path | Source type | Reliability | Main topics | Indexed level | Used by pages | Notes |
| --------- | ---- | ----------- | ----------- | ----------- | ------------- | ------------- | ----- |
| **AQ-NK-ACT2** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT2.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act II (Elegy of Dust and Lamplight), Sandrone, local memory gaps | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT3** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT3.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act III (A Nation That Doesn't Exist), Fatui Special Operation, false sky | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT4** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT4.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act IV (An Elegy for Faded Moonlight), Columbina/Kuutar, lunar authority | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT5** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT5.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act V (A Nocturne of the Far North), Lake Amsvartnir, light refraction | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT6** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT6.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act VI (Melting Moonlight in the Morning Mist), Columbina dialogue, moon returns | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT7** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT7.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act VII (A Traveler on a Winter's Night), Skirk, Abyss sibling, Dottore | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
| **AQ-NK-ACT8** | `sources/provenance/archon_quests/nod-krai/AQ-NK-ACT8.md` | Archon Quest provenance index / extraction index | Medium / provenance candidate | Act VIII (True Moon), Snezhnaya continent unlock, lunar authority | provenance_candidate | N/A | Metadata/revision index only; no full transcript stored locally; future claim mapping required. |
