...
* **Thay đổi lớn phải có hậu quả logic (Timeline consequences):** Nếu bạn thay đổi một sự kiện lớn, phải mô tả logic các phản ứng dây chuyền xảy ra sau đó (ví dụ: Nếu Crepus còn sống, Diluc sẽ không rời Đội Kỵ Sĩ, không có mạng lưới ngầm, và mối quan hệ với Kaeya sẽ không bị đổ vỡ kịch liệt đêm đó).
* **Bảo vệ cốt lõi tinh thần nhân vật (Character OOC handling):** Không được dùng mác "AU" để lột bỏ hoàn toàn bản chất cốt lõi của nhân vật. Diluc dù ở thế giới nào vẫn phải mang tính trách nhiệm cao và trầm lặng; Kaeya dù ở thế giới nào vẫn phải sắc sảo và mang gánh nặng của kẻ đứng giữa hai chiến tuyến.
...
* **Định nghĩa thay đổi sức mạnh (Power system changes):** Nếu thay đổi hệ sức mạnh (ví dụ: cấm dùng phép nguyên tố), luật mới phải được áp dụng đồng nhất cho mọi nhân vật và có thang đo scaling nhất quán.
* **Allowed vs Dangerous modifications:**
  - *Allowed:* Thay đổi điểm rẽ nhánh mốc thời gian, đổi vai trò xã hội của nhân vật, hoặc hồi sinh nhân vật phụ có lý do logic.
  - *Dangerous:* Biến nhân vật thiện thành ác vô cớ, buff OC vượt qua thần linh, hoặc phá hủy hoàn toàn cosmology của thế giới Teyvat mà không có lý giải thuyết phục.
